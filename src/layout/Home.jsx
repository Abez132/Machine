        ...
        <div className="flex flex-col" >
            ...
            <div className="flex flex-wrap justify-center gap-16 px-6 py-16 text-center ">
                {acards.map((card, index) => (
                  <_motions.div whileInView={{ opacity: 1 , scale:1}} initial={{ opacity: 0, scale:0.9 }} transition={{duration:0.5 }} key={index} className="max-w-sm flex  hover:shadow-stone-500 transition delay-1  shadow-lg shadow-stone-700 rounded p-2 flex-col justify-center items-center space-y-4">

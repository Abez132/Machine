        ...
        <div className="flex justify-between items-center p-2 transition-colors  bg-gray-800/70 text-gray-500  duration-300">
            ...
            <div className=" w-1/3 h-10  rounded-3xl flex justify-center p-2 flex-wrap sticky top-4 z-50 gap-2">
                <ul className="space-x-4 hidden md:opacity-100 md:flex md:items-center md:justify-center">
                    <Link to="/"><li 
                        onClick={() =>{setSelected("Home"); setHide(false)}}
                    ...
                    <Link to="/"><li 
                        onClick={() => { scrollToAbout(); setSelected("About Us"); setHide(false)}}
                        className={`hover:border-b-2 text-xs md:text-base lg:text-lg text-cyan-50 transition-colors origin-left transform rounded-l ease-in-out hover:cursor-pointer hover:border-blue-100 ${selected === "About Us" ? "border-b-2 border-blue-100" : ""} ${hide?"hidden":""}`}>About Us</li>
                    </Link>
                    <Link to="/services"><li 
                        onClick={() => { setSelected("Services"); setHide(true)}}
                    ...
                    <Link to="/contact"><li 
                        onClick={() => {setSelected("Contact"); setHide(true)}}
